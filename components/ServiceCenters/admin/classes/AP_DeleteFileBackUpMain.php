<?php
/**
 * Description of AP_DeleteFileBackUpMain
 *
 * @author olga
 */
class AP_DeleteFileBackUpMain {
    ...
    private function getForm() {
        $this->form = "";
        $this->form .= '<form class="AP_Form" name="AP_Form" enctype="multipart/form-data" action="./adminpanel/rus/components/ServiceCenters/element/deleteFileBackUp/" method="POST" accept - charset="UTF-8" required >';
