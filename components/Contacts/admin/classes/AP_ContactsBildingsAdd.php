<?php
/**
 * Description of AP_ContactsBildingsAdd
 *
 * @author olga
 */
class AP_ContactsBildingsAdd extends AdminPanel_ComponentPanelUI_Element_Add {
    ...
    protected function checkAllValue() {         
        ...
        if (isset($_POST['email2']) && $_POST['email2'] != '' && $_POST['email2'] != null) {
            if(!$this->checkValue('email2',"/^([A-Za-z0-9_\.-]+)@([A-Za-z0-9_\.-]+)\.([A-Za-z\.]{2,6})$/")) {
                $error = true;
                $this->checkAllValueErrors[] = "Указан не корректный Email.";
            }
        }
        //phone
    ...
    protected function insertExecute() {
        ...
        $queryShopBuilding = "INSERT INTO `ContactsShopBuilding` SET ";
    ...
    protected function setDefaltInput() { 
        ...
        $this->insertValue['phone3'] = parent::getOriginalPostValue('phone3');
        $this->insertValue['additional3'] = parent::getOriginalPostValue('additional3');
        $this->insertValue['phone4'] = parent::getOriginalPostValue('phone4');
        $this->insertValue['additional4'] = parent::getOriginalPostValue('additional4');
        ...
        $this->insertValue['tueH_s'] = parent::getOriginalPostValue('tueH_s');
        $this->insertValue['tueM_s'] = parent::getOriginalPostValue('tueM_s');
        $this->insertValue['tueH_e'] = parent::getOriginalPostValue('tueH_e');
        $this->insertValue['tueM_e'] = parent::getOriginalPostValue('tueM_e');
        
        $this->insertValue['wedH_s'] = parent::getOriginalPostValue('wedH_s');
        $this->insertValue['wedM_s'] = parent::getOriginalPostValue('wedM_s');
        $this->insertValue['wedH_e'] = parent::getOriginalPostValue('wedH_e');
        $this->insertValue['wedM_e'] = parent::getOriginalPostValue('wedM_e');
        
        $this->insertValue['thuH_s'] = parent::getOriginalPostValue('thuH_s');
        $this->insertValue['thuM_s'] = parent::getOriginalPostValue('thuM_s');
        $this->insertValue['thuH_e'] = parent::getOriginalPostValue('thuH_e');
        $this->insertValue['thuM_e'] = parent::getOriginalPostValue('thuM_e');
        
        $this->insertValue['friH_s'] = parent::getOriginalPostValue('friH_s');
        $this->insertValue['friM_s'] = parent::getOriginalPostValue('friM_s');
        $this->insertValue['friH_e'] = parent::getOriginalPostValue('friH_e');
        $this->insertValue['friM_e'] = parent::getOriginalPostValue('friM_e');
        
        $this->insertValue['satH_s'] = parent::getOriginalPostValue('satH_s');
        $this->insertValue['satM_s'] = parent::getOriginalPostValue('satM_s');
        $this->insertValue['satH_e'] = parent::getOriginalPostValue('satH_e');
        $this->insertValue['satM_e'] = parent::getOriginalPostValue('satM_e');
        
        $this->insertValue['sunH_s'] = parent::getOriginalPostValue('sunH_s');
        $this->insertValue['sunM_s'] = parent::getOriginalPostValue('sunM_s');
        $this->insertValue['sunH_e'] = parent::getOriginalPostValue('sunH_e');
        $this->insertValue['sunM_e'] = parent::getOriginalPostValue('sunM_e');
        ...
        $this->insertValue['shop'] = parent::getOriginalPostValue('shop');
