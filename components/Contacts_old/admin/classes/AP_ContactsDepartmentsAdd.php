<?php
/**
 * Description of AP_ContactsDepartmentsAdd
 *
 * @author olga
 */
class AP_ContactsDepartmentsAdd extends AdminPanel_ComponentPanelUI_Element_Add {
    ...
    protected function insertExecute() {
        ...
        $queryDepartment = "INSERT INTO `ContactDepartments` SET ";
        ...
        $this->uploadFile();
        echo $this->dir.$this->insertValue['alias'].".png";
    }
