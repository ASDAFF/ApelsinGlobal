<?php
/**
 * Description of AP_SaveUnloadedFileMain
 *
 * @author olga
 */
class AP_SaveUnloadedFileMain {
    ...
    private function getForm() {
        $this->form = "";
        $this->form .= '<form class="AP_Form" name="AP_Form" enctype="multipart/form-data" action="./adminpanel/rus/components/ServiceCenters/element/saveUnloadedFile/" method="POST" accept - charset="UTF-8">';
